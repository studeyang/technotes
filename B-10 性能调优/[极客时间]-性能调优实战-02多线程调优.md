...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092022.png" style="zoom:67%;" />
...
- Java 对象头
  ...
  <img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092031.jpg" style="zoom:67%;" />
...
- 偏向锁
  ...
  <img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092035.png" style="zoom: 80%;" />
...
- 轻量级锁
  ...
  <img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092041.png" style="zoom:80%;" />
...
- 自旋锁与重量级锁
  ...
  <img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092047.png" style="zoom:80%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092053.png" style="zoom:80%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092059.jpg" style="zoom:50%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092106.jpg"  />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092110.jpg" style="zoom: 67%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092116.jpg" style="zoom: 67%;" />

如果 state 不等于 0，会判断同步状态低 16 位，如果存在写锁，则获取读锁失败，进入 CLH 阻塞队列；反之，判断当前线程是否应该被阻塞，如果不应该阻塞则尝试 CAS 同步状态，获取成功更新同步锁为读状态。

<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092121.jpg" style="zoom: 67%;" />
...
2. 处理器如何实现原子操作
   ...
   <img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092133.jpg" style="zoom:67%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092143.jpg" style="zoom:50%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092148.jpg" style="zoom: 50%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092154.jpg" style="zoom: 67%;" />
...
![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092202.jpg)
...
![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092206.jpg)

如果是监视某个应用的上下文切换，就可以使用 pidstat 命令监控指定进程的 Context Switch 上下文切换。

![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092210.jpg)
...
- ConcurrentHashMap 🆚 ConcurrentSkipListMap
  ...
  ![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092221.jpg)

  当查询 key 值为 9 的节点时，此时查询路径为：

  ![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092227.jpg)

  当新增一个 key 值为 8 的节点时，首先新增一个节点到最底层的链表中，根据概率算出 level 值，再根据 level 值新建索引层，最后链接索引层的新节点。新增节点和链接索引都是基于 CAS 操作实现。

  ![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092231.jpg)
  ...
  ![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092235.jpg)
...
![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092239.jpg)

**总结**

<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092244.jpg" style="zoom: 67%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092251.jpg" style="zoom:50%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092257.jpg" style="zoom:50%;" />
...
<img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092302.jpg" style="zoom:80%;" />
...
- CPU 密集型任务
  ...
  <img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092307.jpg" style="zoom: 50%;" />
...
- I/O密集型任务
  ...
  <img src="https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092312.jpg" style="zoom: 50%;" />
  ...
  ![](https://gitee.com/yanglu_u/ImgRepository/raw/master/images/20201120092317.jpg)
